...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 170, 141, 16))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(170, 120, 231, 22))
        self.comboBox_2.setObjectName("comboBox_2")
        self.comboBox_3 = QtWidgets.QComboBox(parent=Form)
        self.comboBox_3.setGeometry(QtCore.QRect(170, 170, 231, 22))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Выберите материал"))
